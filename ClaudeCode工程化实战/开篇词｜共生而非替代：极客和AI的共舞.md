...
非常开心。短暂的分别之后（我们的 [《MCP和A2A前沿实战》](https://time.geekbang.org/column/intro/101053801)》在2025年12月刚刚正式结束），我们又在极客时间的专栏中见面了。
...
![](images/942422/b5230a83cfdddde0cf5aa5ba5fd3915c.png)
...
![](images/942422/669f866339dcdbe9e6dcf1yy92404c9e.jpg)

![](images/942422/3f370865eac78325f218bb3bca98c809.jpg)
...
![图片](images/942422/yya83a8eb8ba21ea8bbbb40839ce1425.png)
...
你会发现，Claude Code非常 **懂工程**（并不仅仅是Claude模型本身代码能力强）。他会自动规划任务，自动拆解任务，自动雇佣一堆Sub Agents 做事情，自动确认什么时候要引入人类决策。你不是在一句一句“教它写代码”，而是在和一个工程系统对齐节奏。

为啥Claude Code这么强？因为它直接把 **Agent** 和 **工程治理** 写进了产品架构里——Sub-Agents、Skills、Hooks，这些从Claude Code的设计过程中创建出来的概念，已经超越了“编程工具”本身，形成了通用智能体设计模式的一部分。

现在我们使用Claude Code等AI Coding工具编码，其实你不再只是把自然语言翻译成代码， 而是在 **做设计**，具体来说是做三件更高级的事情：
...
![图片](images/942422/f48afa2fbc5370dce19d59786d2b78b6.png)
...
![图片](images/942422/5bea50d164520de63a9decc0f448cded.png)
...
![图片](images/942422/87c96697b8eac246d76d769bdaef161e.png)

更有意思的是，Skills 的 **渐进式披露架构**——不是把所有知识一股脑灌给 AI，而是按需加载，用到什么加载什么。这解决了 LLM 上下文窗口的根本限制。

![图片](images/942422/e74e0bfded85a6c26c7cfa73228f8e46.png)
...
为什么？因为Claude Code这个级别的 AI 正在让编程能力 **民主化**。以前，想把一个创意变成产品，需要具备这些条件。
...
这 **不是** 一份 Claude Code 入门教程——安装Claude Code（或任何其它AI Coder）之后，你只需要在命令行、IDE的Terminal中输入Claude命令，或者在交互对话框中按照自己的需求开始和它对话，甚至不需要阅读任何说明文档。

![图片](images/942422/7df2a2480d782259af60b1d7bb0ba945.png)

![图片](images/942422/dc589c3326d1ff168e80147ed8c5fb57.png)

![图片](images/942422/1d3ca66f7bce18c115f68300f3916da5.png)
...
![](images/942422/bf272de9671ff198d6dd41935a392dc6.jpg)

每一讲都不会止步于理解概念，而是围绕一个 **真实工程场景** 展开，配套可直接复用的配置与代码（老规矩，佳哥会在 [Github](https://github.com/huangjia2019) 开源所有的教学代码，链接 [在此](https://github.com/huangjia2019/claude-code-engingeering)）。
...
![](images/942422/8af14ba41a1b0acab69a44dbe715dbeb.jpg)

结合最近的热点，我们热点加餐部分也新增了 [Harness](https://time.geekbang.org/column/article/958033) 和 [源码分析](https://time.geekbang.org/column/article/963248) 的部分，而这两个热点里的很多细节，也验证了我们课程的思路是和目前Agent工程主流思路一致。还是那句话，学思想而非工具，把握了这一点，你就更容易在纷繁变化的技术更迭中，建立好自己的认知地图。
...
![](images/942422/315c05a90d043b6300deeb17404a09e8.jpg)![](images/942422/ced128edbdb364424bdf4ecae4323bb9.jpg)

订阅后，戳此加入 [黄佳老师学习交流群](http://jinshuju.net/f/itHX7p)。

课程代码仓库链接： [https://github.com/huangjia2019/claude-code-engingeering](https://github.com/huangjia2019/claude-code-engingeering)