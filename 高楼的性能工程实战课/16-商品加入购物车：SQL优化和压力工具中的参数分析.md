...
![](images/367285/f871d42d3e4528def48fe1202e219a8c.png)
...
![](images/367285/e0035b408239e31deb2c31771f9acbe0.png)
...
![](images/367285/a18fyyf8936d3b906bbe4ccecf661539.png)

- Gateway - Cart：

![](images/367285/c6c3fe9faed90d3476844b293fbc86c5.png)

- Cart - Member ：

![](images/367285/7f5eb3a78a4efcb35855a54bfd71fbb5.png)

- Cart - MySQL：

![](images/367285/acfc5fc9a600a6b2d29dc1e0c980d82a.png)

- Member - MySQL：

![](images/367285/117406c267046fe0771ba8109f801871.png)
...
![](images/367285/42f4042fa1100d96df9989b57f69c9a3.png)
...
![](images/367285/17a4e2d2df0bebda224068869262feb0.png)

在执行计划中，type这一列的参数值为ALL，说明这个SQL没有用到索引。你想想，一个有where条件的语句，又没有用到索引，那它上方的索引到底合不合理呢？我们不妨检查一下这个索引：

![](images/367285/9fb5d843506d87c40660058bab5e4d2c.png)
...
![](images/367285/ba4c981ce540dd1fbaf74547483fa7c3.png)

现在，type列的参数值变为了ref，说明where条件确实走了索引了。那我们再把场景执行起来，看看效果：

![](images/367285/bbbe15d314ab1fab1798bf4f7bc229d8.png)

从结果来看，TPS从50增加到了150以上。响应时间也从750ms左右降到250ms以下。效果显著。

收拾完了第一个SQL后，我们再来收拾另一个SQL。同样地，我们先看它的执行计划：

![](images/367285/9ab86c87e0496699628d4d50a244d161.png)
...
![](images/367285/a1dd2eabfa7e4903f33013241f145d5c.png)
...
![](images/367285/dcfc2e05c8f4a767b284a9a6eb82313c.png)

优化前后的对比图如下：

![](images/367285/100f25cbb012cd7d8902byy884528850.png)
...
![](images/367285/372bfab0665388228fe36b1e167c0cec.png)
...
![](images/367285/c2a3c6e60cd14b69980cbaf8207be638.png)

请你注意，在看性能计数器的时候，每一个工具上的时间窗口一定要对应上。

- User - Gateway：

![](images/367285/64abda597f27856747bc2b7afaa76371.png)

- Gateway - Cart：

![](images/367285/febd0fc79be360bf4b6b477afc26e06b.png)

![](images/367285/75764747266a66d64cfcaf648e93aa71.png)

- Cart - Member：

![](images/367285/ec6b494ca14142f920861c198a3d08aa.png)![](images/367285/d15c9575a080cd2066ba962b7c5517b9.png)

- Cart - MySQL：

![](images/367285/6d9f71f3eeab6705389cf7e7b0ded8c8.png)

- Member - MySQL：

![](images/367285/9fcaef4474c9696ea5a8ffe83315f796.png)
...
![](images/367285/7986171dedc7108ac44eb8f216fdc9a7.png)

你看，这里有一个productSkuCode参数，共用了1000行数据量。

![](images/367285/08bb30112213e9450cd77ee698yy3812.png)

上面的图对应的JMeter脚本是这样的：

![](images/367285/331479527f3ef875426ce77d899d724c.png)
...
![](images/367285/188e028b8ef2f7c3994ba4a1f483bb4b.png)
