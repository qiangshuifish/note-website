...
![](images/245966/097e7f4549eb761c96b61368c416981f.png)
...
![](images/245966/5c180e1119c1c0eb66df03a9c10c5398.png)

这样收到01000001时，根据 [RFC7541](https://tools.ietf.org/html/rfc7541) 规范，前2位为01时，表示这是不包含Value的静态表头部：

![](images/245966/cdf16023ab2c2f4f67f0039b8da47837.png)
...
![](images/245966/81d2301553c825a466b1f709924ba6de.jpg)

这样，接收端在收到下面这串比特位（最后3位填1补位）后，通过查表（请注意每个字符的颜色与比特位是一一对应的）就可以快速解码为：

![](images/245966/5707f3690f91fe54045f4d8154fe4e50.jpg)
...
[![](images/245966/b01f470d5d03082159e62a896b9376c8.png)](https://developers.google.com/web/fundamentals/performance/http2)
...
[![](images/245966/9c068895a9d2dc66810066096172a397.png)](https://developers.google.com/web/fundamentals/performance/http2)

## 服务器如何主动推送资源？

HTTP/1.1不支持服务器主动推送消息，因此当客户端需要获取通知时，只能通过定时器不断地拉取消息。HTTP/2的消息推送结束了无效率的定时拉取，节约了大量带宽和服务器资源。

![](images/245966/f0dc7a3bfc5709adc434ddafe3649316.png)
...
![](images/245966/a1685cc8e24868831f5f2dd961ad3462.png)
...
![](images/245966/3862dad08cecc75ca6702c593a3c9ad1.png)
