...
[![](images/279164/0c0277835b0yy731b11d68d44de00601.jpg)](https://w3techs.com/technologies/details/ce-http2)
...
![](images/279164/f8c65f3f1c405f2c87db1db1c421f891.jpg)
...
[![](images/279164/90f7cc7fed1a46b691303559cde3bce0.jpg)](https://blog.cloudflare.com/http3-the-past-present-and-future/)
...
![](images/279164/12473f12db5359904526d1878bc3c046.gif)

当网络繁忙时，丢包概率会很高，多路复用受到了很大限制。因此， **HTTP/3采用UDP作为传输层协议，重新实现了无序连接，并在此基础上通过有序的QUIC Stream提供了多路复用**，如下图所示：

[![](images/279164/35c3183d5a210bc4865869d9581c93d6.png)](https://blog.cloudflare.com/http3-the-past-present-and-future/)
...
[![](images/279164/79a1d38d2e39c93e600f38ae3a9a04a2.jpg)](https://blog.cloudflare.com/http3-the-past-present-and-future/)
...
![](images/279164/ab3283383013b707d1420b6b4cb8517c.png)
...
![](images/279164/5ecc19ba9106179cd3443eefc1d6b8b4.png)
...
![](images/279164/f41634797dfafeyy4535c3e94ea5f226.png)
...
![](images/279164/5a77916ce399148d0c2d951df7c26c93.png)

其中，显示为E（Encrypt）的字段表示被TLS加密过。当然，Packet Header只是描述了最基本的连接信息，其上的Stream层、HTTP消息也是被加密保护的：

![](images/279164/9edabebb331bb46c6e2335eda20c68af.png)
...
![](images/279164/f6dc5b11f8a240b4283dcb8de5b9a0f4.gif)
...
[![](images/279164/ff629c78ac1880939e5eabb85ab53f4e.png)](https://developers.google.com/web/fundamentals/performance/http2)
...
![](images/279164/3df65a7bb095777f1f8a7fede1a06147.png)

每一个Frame都有明确的类型：

![](images/279164/0e27cd850c0f5b854fd3385cab05755d.png)

前4个字节的Frame Type字段描述的类型不同，接下来的编码也不相同，下表是各类Frame的16进制Type值：

![](images/279164/45b0dfcd5c59a9c8be1c5c9e6f998085.jpg)

在上表中，我们只要分析0x08-0x0f这8种STREAM类型的Frame，就能弄明白Stream流的实现原理，自然也就清楚队头阻塞是怎样解决的了。Stream Frame用于传递HTTP消息，它的格式如下所示：

![](images/279164/10874d334349349559835yy4d4c92b4c.png)
...
![](images/279164/12b117914de00014f90d1yyf12875861.png)
...
[![](images/279164/af869abf09yy1d6d3b0fa5879e300194.jpg)](https://www.oreilly.com/content/http2-a-new-excerpt/)

先来看静态表的变化。在上图中，GET方法映射为数字2，这是通过客户端、服务器协议实现层的硬编码完成的。在HTTP/2中，共有61个静态表项：

![](images/279164/8cd69a7baf5a02d84e69fe6946d5ab21.jpg)

而在QPACK中，则上升为98个静态表项，比如Nginx上的ngx\_http\_v3\_static\_table数组所示：

![](images/279164/0c9c5ab8c342eb6545b00cee8f6b4010.png)
