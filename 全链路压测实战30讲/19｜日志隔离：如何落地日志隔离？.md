...
![图片](images/461201/ca406e7313aeb885b55acfcbbb2db632.jpg)
...
![图片](images/461201/a38f125cdbca92516ec327340b3a8892.png)

再来看一下服务端日志的显示情况，我们看到 MDC 信息已经成功加入到控制台日志了。

![图片](images/461201/b13b120fd154eeb08a5yyf3e638ae757.png)
...
- 正常流量（不带 Header 标记）
  ...
  ![图片](images/461201/a615dd6af2a6dda1db5ffc19b3a486b4.png)

- 压测流量（带Header 标记）

  ![图片](images/461201/3aa7607580f03b7a295a5ca7186509f7.png)


场景设置并发100次，循环100次，执行后，查看控制台。

![图片](images/461201/4ce7e61190ea54a8d2e6ca3580001f2d.png)

在控制台中，我们可以看到正式流量和压测流量的日志已经被分离。

打开配置的日志文件路径，查看日志分离情况。

![图片](images/461201/d47acfa63eb7ede3cyy516154b1100e3.png)
...
![图片](images/461201/d7fc0f51f40ee8a4028a4575a26fee17.png)
...
![图片](images/461201/236619194918664b0bbd265198b99c42.png)
...
![图片](images/461201/ba3d569dc9e4f2b98f21b60c46b7dc27.jpg)
...
![图片](images/461201/67028dd784a126c696yy5e30cef5035f.png)
...
![图片](images/461201/9761e3db136de7fda7ccfe9f056572ab.png)

我们看到，正常日志与压测日志目录是分开的。

但是我们还发现，日志打印是混乱的，日志当中有压测日志，也有正常日志，如下所示：

![图片](images/461201/0957aa532b706c6d4ed0dda5852be9d2.png)
...
![图片](images/461201/bf7cb2d5ce661a8a1dyycb81b511dcf6.png)

可以看到，保存的全部是压测日志，这才是合理的。

我们再打开正常目录中的日志文件查看下内容。

![图片](images/461201/b65123a7fe1d4279c834ec1623671a5f.png)
...
![图片](images/461201/e97d3a38784a3b7954e43f37a6030518.png)
...
![图片](images/461201/d7dbf7a086a6bfac5c11217256ffdb30.png)

我们可以在控制台看到正常的日志。

![图片](images/461201/f817dayy366eeed65119b7b68aaf8399.png)

接下来，我们查看下正常的日志文件内容。

![图片](images/461201/4112f2cyy484121927d835d863e9f61a.png)
...
![图片](images/461201/23e2d8b3ce0a3cbeffyyd7c4f53067b1.png)
