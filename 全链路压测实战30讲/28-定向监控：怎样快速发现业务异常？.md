...
![图片](images/470494/707389253947f6528d96b34a6d809272.png)

Grafana 可视化看板：

![图片](images/470494/c456f5e15124a0b2de374d592df3fdb0.png)
...
![图片](images/470494/61805753c8f81f09a652b550546693f3.jpg)
...
![图片](images/470494/caa0b2e053010219ba1640723e05691d.png)
...
![图片](images/470494/0cb7a0b475b38187729fb84d5b0ff3e2.png)
...
![图片](images/470494/da2dd20b76883b8177228a84b01955ed.png)

这样就能看到目前 Prometheus 收集的 Metrics 的路径了：

![图片](images/470494/dbc97b4ce6e252092e0b3a2d70a961f8.png)

再次点击 [http://localhost:8086/actuator/prometheus](http://localhost:8086/actuator/prometheus) ，显示的信息如下：

![图片](images/470494/3cc9f80a95f8fe2f31a8e8d7b2fbc27b.png)
...
![图片](images/470494/8006a7ddeeb8084b59355f3da9528b6a.png)

最后，我们只要在 Prometheus 控制台输入表达式语言 PromQL，就能查询 Metric 相关的数据了。

![图片](images/470494/211874f96dcf5f4b8a630028c3a6085f.png)
...
![图片](images/470494/b7a74ceee499717ed32b4cedb00ac094.png)

第二步，选择 Prometheus 数据源：

![图片](images/470494/6026237ce43f4e5e18f00793df3f7313.png)

第三步，配置数据源地址：

![图片](images/470494/38b973fa0c059b2f47d5066763d102c7.png)

第四步，测试数据源是否配置成功：

![图片](images/470494/b07fcdae910bdf78d5f14e5e5a54bb1c.png)

第五步，为了添加 Metrics 的图表，选择“创建第一个 dashboard”：

![图片](images/470494/aec7782d843ac42d19e2aa1ca99f071c.png)

第六步，添加一个空面板：

![图片](images/470494/6c7bdd194462f41bf2e3e4730e4e1e7e.png)

第七步，在 Data source 中选择 Prometheus 数据源，在 Metrics browser 中输入 Metric PromQL 表达式：

![图片](images/470494/fbcdeae7cdf12af72cd5bc6117871654.png)

第八步，在右侧控件类型中选择图表控件：

![图片](images/470494/b69b42ba88a3b9f9d9b80e7ddd84bd7b.png)

图表创建好之后，我们就可以看到 Metric 数据了。

![图片](images/470494/ffc9f0fbc3a110a14ba74bfcc3a1f221.png)

因为需要展示不同的 Metrics，所以我们要重复上面的步骤，增加订单成功次数、订单失败次数、订单金额总数等 Metrics 绑定的图表。

创建好的可视化看板你可以参考下面这张图：

![图片](images/470494/09549d4e834eeb48a478c51854acb65c.png)
...
![图片](images/470494/e0640db455a88c3dec4ed74bf1d52a2e.png)

执行 JMeter 后，我们通过 Grafana 看板中显示的正常和失败订单的数据，可以知道 demo 的埋点已经成功了：

![图片](images/470494/e7d93ccee8dccd23c26a80d0064f79f1.png)
...
![图片](images/470494/f0119f47efc4bd559b2d751517e8942d.png)
...
![图片](images/470494/0a8d24ba801b931727ae73243d597325.png)
...
![图片](images/470494/396c716fde4740557e038cfcccd4205a.png)

然后启动项目观察日志，发现已经有 actuator 对应的 URL 路径了。

![图片](images/470494/a7cf934993570bb76f2d3eac068ed796.png)

在浏览器中访问地址，可以看到，Metrics 数据就都已经显示出来了。

![图片](images/470494/5bf27bc93cf9f226aec415b82yy6dd46.png)
...
![图片](images/470494/0f92e080b768f97ef77353ccdba24840.png)
...
![图片](images/470494/d434aeb1f688cc1e63956ebb0143e30f.png)

![图片](images/470494/0bb51c30dca3fbac51801c4098edaee3.png)
