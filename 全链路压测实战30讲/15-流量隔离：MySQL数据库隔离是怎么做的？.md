...
![图片](images/447129/e96da5730379c3c94215f327069674dd.jpg)
...
![图片](images/447129/7619f4a70f6f8ee62dfa8fd43711dc67.png)

上面是简单的链路图，你可以很清楚地知道，哪些服务与 MySQL 数据库有关系。为了方便你更直观地理解，我给你画了个思维导图。

![图片](images/447129/964818d5c9363fb9eab7d26fc40f0b6c.jpg)
...
![图片](images/447129/8d3f9d1e7506333533d673c52de7f3e8.png)
...
![图片](images/447129/faafe66d254a94a18936867c97d92a3d.png)
...
![图片](images/447129/63d5c6e03485a782195925e5f7bf51ac.png)
...
![图片](images/447129/5932e537d1338b0a2c09010cfdbeb6a7.png)
...
![图片](images/447129/3d52080337e01b054be1aa3eb821dca9.jpg)
...
![图片](images/447129/20e48d67b4ac08a19a2964635174c4ed.png)
...
![图片](images/447129/7ac95dbc0d1ac174yye8d518fc373c8c.png)

在 body 中的“昵称”中写入“性能测试-我是正常流量”，请求成功显示如下：

![图片](images/447129/5ea87c5418d16448168bd861a968ccf5.png)

为了验证是否插入成功，需要打开 MySQL 输入查询语句。在查询前，要先通过日志判断出要使用哪个数据库，这样才能查到结果。

![图片](images/447129/85cc2af8da0ef0yydb8d5d3befab1332.png)
...
![图片](images/447129/4d36793754b8f2bfd2b9dd4c3f5f3f15.png)
...
![图片](images/447129/742584f24110d6025b50693b98d23d62.png)

打开 JMeter，在 View Results Tree 中查看结果。

![图片](images/447129/854be53a09b5b366596cf72da3d4d5a3.png)

在 SpringBoot 工程中查看请求日志，验证是否成功切换数据源，日志显示目前的标记为 7DGroup ，因而应该走 shadow（影子库）数据源，也就是数据源中的 mall\_shadow 库。

![图片](images/447129/yy268e668bbec292069312dc10b92ed1.png)
...
![图片](images/447129/f248b5bb921a22f8688aa18de1655dd8.png)
...
![图片](images/447129/99ee4d4daa9fe5fe78d99c2d8fdc8105.jpg)

这里实现的核心逻辑图如下：

![图片](images/447129/4e09a1ca5e528b306697eccc9f0eedbf.jpg)

我们还是使用上一节课搭建的环境，如果忘了这个环境怎么搭，你可以到上一讲复习一下。

首先，启动项目，显示如下：

![图片](images/447129/3818be42a830468aa5147b1bfbcee3e1.png)

可以看到，Nacos 注册中心有网关、会员、购物车、订单服务。

![图片](images/447129/b9c1c74f093289ee0d0e5a8152d110ac.png)
...
![图片](images/447129/1fc2d15d66b86e9d780f5a7f70b8d155.png)
...
![图片](images/447129/cc57a1046256f398dda747ca31762475.png)
...
![图片](images/447129/e357e0000c110d16674bd31db2d08746.png)
...
![图片](images/447129/68a37aa327227c471d328d386eb40637.png)

- 添加请求 Header 标记（压测请求）

![图片](images/447129/2c03d9e1dac6bba26597aa65af01e295.png)

接下来，我们要验证结果是否跟预期想的一致。点击 JMeter 请求，在响应结果中查看结果。

- 不添加请求 Header 标记（正式请求）

![图片](images/447129/1e9512fdf1db5b43168ea9c3ceccfbce.png)

- 添加请求 Header 标记（压测请求）

![图片](images/447129/554656e57b399f4794da157e049b7aa3.png)
...
![图片](images/447129/648f9be5f21048e2ba920516973797e2.png)

- 添加请求 Header 标记（影子库）

![图片](images/447129/7427433a234112c83453212cdc59123a.png)

Zipkin 链路全貌图为：

![图片](images/447129/6bd3dca5622bd201b0505424470364f4.png)
...
![图片](images/447129/9ab23782cb816823a2989f732254764b.png)

### 配置 AOP 切面

然后，在 AOP 类中修改 Pointcut 类中的注解。需要注意修改中间的文本框，其它地方与 demo 中保持一致即可。

![图片](images/447129/3870db5171b3726536e4477e03143ec9.png)

具体的代码你可以参考我给出的图片。

![图片](images/447129/6e2fa4716ebca9507edd64e6f9d70e2d.png)
...
![图片](images/447129/19c6a67f0db592d6bb434336f404ee0b.png)

改造完成后，我们启动工程，验证数据库是否成功。因为这个工程比较复杂，所以还需要启动网关服务和认证服务，启动的数据库启动日志如下：

![图片](images/447129/2c9d888af95a3a8d02b2d0659ff7c734.png)

启动系统如下：

![图片](images/447129/f2d3f60cc9496204aec733878ea3a903.png)
...
![图片](images/447129/ed791084acb7b389a0f9f93f5a6e5116.png)
...
![图片](images/447129/6bd630049yydcdb64ba3d52109cd92c5.png)
...
![图片](images/447129/3dbf27fd57f57c99e4b3fafb6af71a76.png)
...
![图片](images/447129/1316923170f0fda99cc1e5e9e267e410.png)
