...
![](images/136886/ab692d1e072df378bc78fef6245205a3.png)

图1 JIT编译模式示意图

- AOT（Ahead Of Time），指的是提前编译或运行前编译，在Release模式中使用，可以为特定的平台生成稳定的二进制代码，执行性能好、运行速度快，但每次执行均需提前编译，开发调试效率低。

![](images/136886/fe8712b8a36a032b0646ed85fec9b2a5.png)
...
![](images/136886/2dfbedae7b95dd152a587070db4bb9fa.png)
