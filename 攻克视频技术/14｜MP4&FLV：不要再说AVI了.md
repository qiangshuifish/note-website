...
![图片](images/471074/38cc18a2a824e2001ae4d38818e691c0.jpeg)

其总体格式图如下：

![](images/471074/d9e526be063eb8382535caa585d9f600.jpeg)
...
![图片](images/471074/da922577ddc53bcac52b1bcccd433130.jpeg)

音频Tag Data的第一个字节表示音频的编码方式、采样率和位宽等信息，如下图所示。之后就是音频数据了。

![图片](images/471074/4a226cc369df7fd8ee7f469694e47f5a.jpeg)

视频Tag的第1个字节包含了这个Tag的视频帧类型和视频编码方式，格式如下图：

![图片](images/471074/1fd4c7db11320f1f163b969f2d411451.jpeg)

对于H264数据，紧接着会有4字节的AVC Packet Type格式，如下图所示：

![图片](images/471074/a86a39594d3295f431763959d53487a1.jpeg)
...
![图片](images/471074/12d630497d4f0e540a764e62dd7f34bb.jpeg)

如果AVC包类型为1，则数据格式如下图所示：

![图片](images/471074/be79ca64a849568c1e19ce3399750e81.png)
...
![图片](images/471074/e888133ea73c584a711098869f6f6790.jpeg)

根据Box Header中的type我们将box分为不同类型的box，每一种不同的box对应的Box Data都是不一样。Box Data里面又可以嵌套box。MP4的总体box分布图如下图所示：

![图片](images/471074/7f22c603689c17b42098b32eyyf034d1.jpeg)
...
![图片](images/471074/6a94cf7fcee63b81bd1375f42a206275.jpeg)

ctts box放置着CTS，也就是每一个sample的PTS和DTS的差值。

![图片](images/471074/58b59fc37129abcb6e7398f98cb6ea8d.jpeg)

stss box中放置的是哪些sample是关键帧。

![图片](images/471074/94347b1d78b04a9995yyea1110yy338a.jpeg)

stsc box中放置的是sample到chunk的映射表，也就是哪些sample属于哪个chunk。

![图片](images/471074/034ec8ab5228e2c65240c7fdb2f190a5.jpeg)

stco box或co64 box中放置着每个chunk在文件中的偏移地址。

![图片](images/471074/5ca7437ed49766cfc827fa75891680ca.jpeg)

stsz box中放置着每一个sample的大小。

![图片](images/471074/aa0b8bef4d0c23da67c1468e92682599.jpeg)
...
![图片](images/471074/aaac0910d536a50191854cae468b307c.jpeg)

而sample是不是关键帧，我们只需要通过stss对应每一个sample序号查询就可以得到。

![图片](images/471074/54fa75cc33d0690c8c206f6bac6b82c5.jpeg)
...
![图片](images/471074/02d684c8ea5e8405fb8f2ce341b90d7b.jpeg)
