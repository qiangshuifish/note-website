...
![](images/460622/414d876c07f4ef55edeb1047c09e43c9.png)

还是看着用户登录时序图分析，在登录页面，用户输入注册时填写的用户名和密码，登录进入问题列表页。

![图片](images/460622/94e7cbfb5313cf7abbe6d91222e15d6d.png)

而在问题列表页的头部，右上角有个登出按钮，这个登出按钮能控制用户进行登出操作。

![图片](images/460622/a9fd4cfce64ac76a15b72819e925bbc0.png)
...
![图片](images/460622/f5bc6d57ee3b8c7f4afba019d9418df3.png)
...
![图片](images/460622/a286446be2ebd484821a722377879581.png)

将生成的文件编译进入项目中， `./bbs build self` ：

![图片](images/460622/10dabd4e1560e8bf851ba2f25d47285a.png)

然后你可以运行命令 `./bbs app start` 启动App，或者选择调试模式 `./bbs dev backend` 来启动swagger-UI，这里因为我们还是在调试状态，所以选择启动调试模式：

![图片](images/460622/02f16f255bcec434ddecf764e663acf3.png)
...
![图片](images/460622/74f8366d6aeba29e8df198488e808c80.png)
...
![](images/460622/5e1f623yyd5f48fb73786e426c966913.jpg)
