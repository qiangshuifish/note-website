...
代码的组织顺序很清晰，先预处理请求，再处理业务逻辑，最后处理返回值，你发现没有这种顺序，其实很符合设计模式中的装饰器模式。装饰器模式，顾名思义，就是在核心处理模块的外层增加一个又一个的装饰，类似洋葱。![](images/420006/f94ccc78af2ca491afe1591e674e3f2c.jpg)
...
请求流的流向如下图所示：![](images/420006/e1aa5937627e46c8b2b21e45426f342a.jpg)
...
所以就需要我们在Context这个数据结构中想一些办法了。回顾下目前有的数据结构：Core、Context、Tree、Node、Group。![](images/420006/8ef582e74e9c5ca1c0f54e7c1d75a67b.jpg)
...
![](images/420006/49c2d50b26d48e338c3acd2e1374f4c8.jpg)
...
- 第二个是在每个中间件的逻辑代码中，用于调用下个中间件。
  ...
  ![](images/420006/73a80752cf6d94b90febd2e23e80bc3c.jpg)
...
如何使用控制器链路，我们就讲完了，再看控制器链路如何注册，就是之前UML图的左边部分。![](images/420006/3c2012fcfcabcfc0159e4ecec2fdb8b5.jpg)
...
![](images/420006/7f26e60d79ec987dba10a1b5045aa2ab.jpg)
...
我们还是基于第一节课讲的net/http的主流程逻辑来思考，关键结论有一点是， **每个HTTP连接都会开启一个Goroutine为其服务**，所以很明显， net/http 的进程模型是单进程、多协程。![](images/420006/0fa86b64b6d1b1e96560420243ec6aee.jpg)
...
![](images/420006/b8a053e4650ec9560754383d0f3974yy.png)
