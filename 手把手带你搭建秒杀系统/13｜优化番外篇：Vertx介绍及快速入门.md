...
![图片](images/429877/a525b96dd2cfd7cdc0e59f464fef988f.jpg)
...
![图片](images/429877/3cfbc9eaa68e8b8c0bc5be5acc85c9cc.png)
...
![图片](images/429877/4254467264d63ebc102187208d884e16.png)

那我们继续看下InitialModule类都配置了些什么：

![图片](images/429877/5f4c6a996b938b90a5de67eacd6f70b9.png)

这里首先是导入Spring的配置文件spring-config，同时配置Spring的包扫描路径，其次是初始化Vertx，然后开始部署Verticle实例，这里Vertx的初始化配置和部署实例的配置如下：

![图片](images/429877/c63a5950d369238b7bc8c11148b8568a.png)
...
![图片](images/429877/5220cb6cdff8c2f0a7d3fc38fd59ca39.png)
...
![图片](images/429877/d0fd1ab2byy795abccd9035710531b0d.png)

这里首先是从Spring管理的Bean中，找出添加了我们自定义注解RequestMapping的类，然后遍历，将请求URL与对应的类和方法注册到Router中，具体的注册方法如下：

![图片](images/429877/c151ef7027ac0e2ebb1fd427fc3eb369.png)
...
![图片](images/429877/ca76e89abd8aaee1df8f7c9b07f7cfc7.png)
