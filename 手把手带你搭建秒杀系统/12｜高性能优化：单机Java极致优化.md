...
![](images/429098/09f73f9dabbyyabe8c78dcbc0abfc79c.jpg)
...
![图片](images/429098/0cdfc74546cdaa36b5003acef59fac76.jpg)

如上图所示，就代表分别使用的是NIO模式和NIO2(AIO)模式，当然还可以选择BIO模式以及APR模式。具体对比可参考下表：

![图片](images/429098/8966cb8e33788bdded84f325d19ed942.png)

那说完线程模型的选择，从上图中我们可以看到有个Tomcat线程池的概念，它是通过哪些配置来控制的呢？这里我们只摘几个重要的配置说一下，详细信息如下表所示：

![图片](images/429098/ac0fddbddeb80f53565debe35de5e4db.png)
...
![](images/429098/7614fe72f3cff040947c1e5yy9c119f8.jpg)
...
![](images/429098/0ca1cd1d776fdb9c272f63b23c657d64.jpg)
...
![图片](images/429098/2340f6d3b57a6310fda38622d93cab41.png)
...
![](images/429098/ce46453e685ed16f58ae3f365a1cd376.jpg)
...
![](images/429098/a48171f5a6a8fc510d18c19aa0f29c13.jpg)
...
![](images/429098/2afaeb5e409a78b968812f6363fb0881.jpg)
...
![图片](images/429098/50387966e16a2c74266f815f6872ea10.png)

然后是CMS，在ParallelGC配置参数的基础上增加以下配置：

![图片](images/429098/e7df72c932f39fb02b3566ab388f83ea.png)

再说下G1的优化配置（在使用了G1的情况下，就不要设置 -Xmn 和 XX:NewRatio了），同样是在ParallelGC配置参数的基础上增加以下配置：

![图片](images/429098/37351b2260ffff7384ea30cb43bbb76b.png)
