import{_ as s,H as n,f as e,i as p}from"./chunks/framework.BH2BK_3i.js";const u=JSON.parse('{"title":"答疑篇：代码篇思考题集锦（三）","description":"","frontmatter":{},"headers":[{"level":3,"title":"13 | 日志：日志记录真没你想象的那么简单","slug":"_13-日志-日志记录真没你想象的那么简单","link":"#_13-日志-日志记录真没你想象的那么简单","children":[]},{"level":3,"title":"14 | 文件IO：实现高效正确的文件读写并非易事","slug":"_14-文件io-实现高效正确的文件读写并非易事","link":"#_14-文件io-实现高效正确的文件读写并非易事","children":[]},{"level":3,"title":"15 | 序列化：一来一回你还是原来的你吗？","slug":"_15-序列化-一来一回你还是原来的你吗","link":"#_15-序列化-一来一回你还是原来的你吗","children":[]},{"level":3,"title":"16 | 用好Java 8的日期时间类，少踩一些“老三样”的坑","slug":"_16-用好java-8的日期时间类-少踩一些-老三样-的坑","link":"#_16-用好java-8的日期时间类-少踩一些-老三样-的坑","children":[]},{"level":3,"title":"17 | 别以为“自动挡”就不可能出现OOM","slug":"_17-别以为-自动挡-就不可能出现oom","link":"#_17-别以为-自动挡-就不可能出现oom","children":[]},{"level":3,"title":"18 | 当反射、注解和泛型遇到OOP时，会有哪些坑？","slug":"_18-当反射、注解和泛型遇到oop时-会有哪些坑","link":"#_18-当反射、注解和泛型遇到oop时-会有哪些坑","children":[]},{"level":3,"title":"19 | Spring框架：IoC和AOP是扩展的核心","slug":"_19-spring框架-ioc和aop是扩展的核心","link":"#_19-spring框架-ioc和aop是扩展的核心","children":[]},{"level":3,"title":"20 | Spring框架：框架帮我们做了很多工作也带来了复杂度","slug":"_20-spring框架-框架帮我们做了很多工作也带来了复杂度","link":"#_20-spring框架-框架帮我们做了很多工作也带来了复杂度","children":[]}],"relativePath":"Java业务开发常见错误100例/答疑篇：代码篇思考题集锦（三）.md","filePath":"Java业务开发常见错误100例/答疑篇：代码篇思考题集锦（三）.md","lastUpdated":1779815815000}'),t={name:"Java业务开发常见错误100例/答疑篇：代码篇思考题集锦（三）.md"};function l(i,a,o,r,c,g){return n(),e("div",null,[...a[0]||(a[0]=[p(`<h1 id="答疑篇-代码篇思考题集锦-三" tabindex="-1">答疑篇：代码篇思考题集锦（三） <a class="header-anchor" href="#答疑篇-代码篇思考题集锦-三" aria-label="Permalink to &quot;答疑篇：代码篇思考题集锦（三）&quot;">​</a></h1><p>你好，我是朱晔。</p><p>今天，我们继续一起分析这门课第13~20讲的课后思考题。这些题目涉及了日志、文件IO、序列化、Java 8日期时间类、OOM、Java高级特性（反射、注解和泛型）和Spring框架的16道问题。</p><p>接下来，我们就一一具体分析吧。</p><h3 id="_13-日志-日志记录真没你想象的那么简单" tabindex="-1"><a href="https://time.geekbang.org/column/article/220307" target="_blank" rel="noreferrer">13 | 日志：日志记录真没你想象的那么简单</a> <a class="header-anchor" href="#_13-日志-日志记录真没你想象的那么简单" aria-label="Permalink to &quot;[13 \\| 日志：日志记录真没你想象的那么简单](https://time.geekbang.org/column/article/220307)&quot;">​</a></h3><p><strong>问题1：</strong> 在讲“为什么我的日志会重复记录？”的案例时，我们把INFO级别的日志存放到_info.log中，把WARN和ERROR级别的日志存放到_error.log中。如果现在要把INFO和WARN级别的日志存放到_info.log中，把ERROR日志存放到_error.log中，应该如何配置Logback呢？</p><p>答：要实现这个配置有两种方式，分别是：直接使用EvaluatorFilter和自定义一个Filter。我们分别看一下。</p><p>第一种方式是，直接使用logback自带的EvaluatorFilter：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;lt;filter class=&quot;ch.qos.logback.core.filter.EvaluatorFilter&quot;&amp;gt;</span></span>
...
<span class="line"><span>&amp;lt;/filter&amp;gt;</span></span></code></pre></div><p>第二种方式是，自定义一个Filter，实现解析配置中的“|”字符分割的多个Level：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class MultipleLevelsFilter extends Filter&amp;lt;ILoggingEvent&amp;gt; {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>然后，在配置文件中使用这个MultipleLevelsFilter就可以了（完整的配置代码参考 <a href="https://github.com/JosephZhu1983/java-common-mistakes/blob/master/src/main/java/org/geekbang/time/commonmistakes/logging/duplicate/multiplelevelsfilter.xml" target="_blank" rel="noreferrer">这里</a>）：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;lt;filter class=&quot;org.geekbang.time.commonmistakes.logging.duplicate.MultipleLevelsFilter&quot;&amp;gt;</span></span>
<span class="line"><span>    &amp;lt;levels&amp;gt;INFO|WARN&amp;lt;/levels&amp;gt;</span></span>
<span class="line"><span>&amp;lt;/filter&amp;gt;</span></span></code></pre></div><p><strong>问题2：</strong> 生产级项目的文件日志肯定需要按时间和日期进行分割和归档处理，以避免单个文件太大，同时保留一定天数的历史日志，你知道如何配置吗？可以在 <a href="http://logback.qos.ch/manual/appenders.html#RollingFileAppender" target="_blank" rel="noreferrer">官方文档</a> 找到答案。</p><p>答：参考配置如下，使用SizeAndTimeBasedRollingPolicy来实现按照文件大小和历史文件保留天数，进行文件分割和归档：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;lt;rollingPolicy class=&quot;ch.qos.logback.core.rolling.SizeAndTimeBasedRollingPolicy&quot;&amp;gt;</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>会得到如下输出：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>1 false</span></span>
<span class="line"><span>2147483648 true</span></span>
<span class="line"><span>1 2147483648</span></span></code></pre></div><p>可以看到，值设置1的时候类型不是Long，设置2147483648的时候是Long。也就是使用RedisTemplate&lt;String, Long&gt;不一定就代表获取的到的Value是Long。</p><p>所以，这边我写了一个getLongFromRedis方法来做转换避免出错，判断当值是Integer的时候转换为Long。</p><p><strong>问题2：</strong> 你可以看一下Jackson2ObjectMapperBuilder类源码的实现（注意configure方法），分析一下其除了关闭FAIL_ON_UNKNOWN_PROPERTIES外，还做了什么吗？</p><p>答：除了关闭FAIL_ON_UNKNOWN_PROPERTIES外，Jackson2ObjectMapperBuilder类源码还主要做了以下两方面的事儿。</p><p>第一，设置Jackson的一些默认值，比如：</p><ul><li>MapperFeature.DEFAULT_VIEW_INCLUSION设置为禁用；</li><li>DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES设置为禁用。</li></ul><p>第二，自动注册classpath中存在的一些jackson模块，比如：</p><ul><li>jackson-datatype-jdk8，支持JDK8的一些类型，比如Optional；</li><li>jackson-datatype-jsr310， 支持JDK8的日期时间一些类型。</li><li>jackson-datatype-joda，支持Joda-Time类型。</li><li>jackson-module-kotlin，支持Kotlin。</li></ul><h3 id="_16-用好java-8的日期时间类-少踩一些-老三样-的坑" tabindex="-1"><a href="https://time.geekbang.org/column/article/224240" target="_blank" rel="noreferrer">16 | 用好Java 8的日期时间类，少踩一些“老三样”的坑</a> <a class="header-anchor" href="#_16-用好java-8的日期时间类-少踩一些-老三样-的坑" aria-label="Permalink to &quot;[16 \\| 用好Java 8的日期时间类，少踩一些“老三样”的坑](https://time.geekbang.org/column/article/224240)&quot;">​</a></h3><p><strong>问题1：</strong> 在这一讲中，我多次强调了Date是一个时间戳，是UTC时间、没有时区概念。那，为什么调用其toString方法，会输出类似CST之类的时区字样呢？</p><p>答：关于这个问题，参考toString中的相关源码，你可以看到会获取当前时区（取不到则显示GMT）进行格式化：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public String toString() {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>我在源码中提供了一个 <a href="https://github.com/JosephZhu1983/java-common-mistakes/blob/master/src/main/java/org/geekbang/time/commonmistakes/oom/groovyoom/GroovyOOMController.java" target="_blank" rel="noreferrer">测试程序</a>，你可以直接去看一下。</p><h3 id="_18-当反射、注解和泛型遇到oop时-会有哪些坑" tabindex="-1"><a href="https://time.geekbang.org/column/article/225596" target="_blank" rel="noreferrer">18 | 当反射、注解和泛型遇到OOP时，会有哪些坑？</a> <a class="header-anchor" href="#_18-当反射、注解和泛型遇到oop时-会有哪些坑" aria-label="Permalink to &quot;[18 \\| 当反射、注解和泛型遇到OOP时，会有哪些坑？](https://time.geekbang.org/column/article/225596)&quot;">​</a></h3><p><strong>问题1：</strong> 泛型类型擦除后会生成一个bridge方法，这个方法同时又是synthetic方法。除了泛型类型擦除，你知道还有什么情况编译器会生成synthetic方法吗？</p><p>答：Synthetic方法是编译器自动生成的方法（在源码中不出现）。除了文中提到的泛型类型擦除外，Synthetic方法还可能出现的一个比较常见的场景，是内部类和顶层类需要相互访问对方的private字段或方法的时候。</p><p>编译后的内部类和普通类没有区别，遵循private字段或方法对外部类不可见的原则，但语法上内部类和顶层类的私有字段需要可以相互访问。为了解决这个矛盾，编译器就只能生成桥接方法，也就是Synthetic方法，来把private成员转换为package级别的访问限制。</p><p>比如如下代码，InnerClassApplication类的test方法需要访问内部类MyInnerClass类的私有字段name，而内部类MyInnerClass类的test方法需要访问外部类InnerClassApplication类的私有字段gender。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class InnerClassApplication {</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>编译器会为InnerClassApplication和MyInnerClass都生成桥接方法。</p><p>如下图所示，InnerClassApplication的test方法，其实调用的是内部类的access$000静态方法：</p><p><a class="image-link" href="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/93a0fd1feb705be9fd63c3b963943c66.png" target="_blank" rel="noopener" title="点击查看原图"><img src="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/93a0fd1feb705be9fd63c3b963943c66.png" alt=""></a></p><p>这个access$000方法是Synthetic方法：</p><p><a class="image-link" href="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/2aa967cfbd7832d0893605c4249363f0.png" target="_blank" rel="noopener" title="点击查看原图"><img src="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/2aa967cfbd7832d0893605c4249363f0.png" alt=""></a></p><p>而Synthetic方法的实现转接调用了内部类的name字段：</p><p><a class="image-link" href="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/064809b7fba7dc34f5c955a1a7dbf33d.png" target="_blank" rel="noopener" title="点击查看原图"><img src="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/064809b7fba7dc34f5c955a1a7dbf33d.png" alt=""></a></p><p>反过来，内部类的test方法也是通过外部类InnerClassApplication类的桥接方法access$100调用到其私有字段：</p><p><a class="image-link" href="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/ebefeeda2de626ca8cbdf5388763669e.png" target="_blank" rel="noopener" title="点击查看原图"><img src="https://raw.githubusercontent.com/qiangshuifish/note-website/note-website/Java%E4%B8%9A%E5%8A%A1%E5%BC%80%E5%8F%91%E5%B8%B8%E8%A7%81%E9%94%99%E8%AF%AF100%E4%BE%8B/images/262560/ebefeeda2de626ca8cbdf5388763669e.png" alt=""></a></p><p><strong>问题2：</strong> 关于注解继承问题，你觉得Spring的常用注解@Service、@Controller是否支持继承呢？</p><p>答：Spring的常用注解@Service、@Controller，不支持继承。这些注解只支持放到具体的（非接口非抽象）顶层类上（来让它们成为Bean），如果支持继承会非常不灵活而且容易出错。</p><h3 id="_19-spring框架-ioc和aop是扩展的核心" tabindex="-1"><a href="https://time.geekbang.org/column/article/227917" target="_blank" rel="noreferrer">19 | Spring框架：IoC和AOP是扩展的核心</a> <a class="header-anchor" href="#_19-spring框架-ioc和aop是扩展的核心" aria-label="Permalink to &quot;[19 \\| Spring框架：IoC和AOP是扩展的核心](https://time.geekbang.org/column/article/227917)&quot;">​</a></h3><p><strong>问题1：</strong> 除了通过@Autowired注入Bean外，还可以使用@Inject或@Resource来注入Bean。你知道这三种方式的区别是什么吗？</p><p>答：我们先说一下使用@Autowired、@Inject和@Resource这三种注解注入Bean的方式：</p><ul><li>@Autowired，是Spring的注解，优先按照类型注入。当无法确定具体注入类型的时候，可以通过@Qualifier注解指定Bean名称。</li><li>@Inject：是JSR330规范的实现，也是根据类型进行自动装配的，这一点和@Autowired类似。如果需要按名称进行装配，则需要配合使用@Named。@Autowired和@Inject的区别在于，前者可以使用required=false允许注入null，后者允许注入一个Provider实现延迟注入。</li><li>@Resource：JSR250规范的实现，如果不指定name优先根据名称进行匹配（然后才是类型），如果指定name则仅根据名称匹配。</li></ul><p><strong>问题2：</strong> 当Bean产生循环依赖时，比如BeanA的构造方法依赖BeanB作为成员需要注入，BeanB也依赖BeanA，你觉得会出现什么问题呢？又有哪些解决方式呢？</p><p>答：Bean产生循环依赖，主要包括两种情况：一种是注入属性或字段涉及循环依赖，另一种是构造方法注入涉及循环依赖。接下来，我分别和你讲一讲。</p><p>第一种，注入属性或字段涉及循环依赖，比如TestA和TestB相互依赖：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;#64;Component</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>针对这个问题，Spring内部通过三个Map的方式解决了这个问题，不会出错。基本原理是，因为循环依赖，所以实例的初始化无法一次到位，需要分步进行：</p><ol><li>创建A（仅仅实例化，不注入依赖）；</li><li>创建B（仅仅实例化，不注入依赖）；</li><li>为B注入A（此时B已健全）；</li><li>为A注入B（此时A也健全）。</li></ol><p>网上有很多相关的分析，我找了 <a href="https://cloud.tencent.com/developer/article/1497692" target="_blank" rel="noreferrer">一篇比较详细的</a>，可供你参考。</p><p>第二种，构造方法注入涉及循环依赖。遇到这种情况的话，程序无法启动，比如TestC和TestD的相互依赖：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;#64;Component</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>这种循环依赖的主要解决方式，有2种：</p><ul><li>改为属性或字段注入；</li><li>使用@Lazy延迟注入。比如如下代码：</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&amp;#64;Component</span></span>
<span class="line"><span>public class TestC {</span></span>
<span class="line"><span>    &amp;#64;Getter</span></span>
<span class="line"><span>    private TestD testD;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>我在GitHub上第20讲对应的源码中更新了我的实现，你可以点击 <a href="https://github.com/JosephZhu1983/java-common-mistakes/blob/master/src/main/java/org/geekbang/time/commonmistakes/springpart2/custompropertysource/CommonMistakesApplication.java" target="_blank" rel="noreferrer">这里</a> 查看。有一些同学会问，这么做的意义到底在于什么，为何不直接使用类似Apollo这样的配置框架呢？</p><p>其实，我们的目的就是不希望让开发人员手动配置数据库信息，希望程序启动的时候自动替换占位符实现自动配置（从CMDB直接拿着应用程序ID来换取对应的数据库信息。你可能会问了，一个应用程序ID对应多个数据库怎么办？其实，一般对于微服务系统来说，一个应用就应该对应一个数据库）。这样一来，除了程序其他人都不会接触到生产的数据库信息，会更安全。</p><p>以上，就是咱们这门课的第13~20讲的思考题答案了。</p><p>关于这些题目，以及背后涉及的知识点，如果你还有哪里感觉不清楚的，欢迎在评论区与我留言，也欢迎你把今天的内容分享给你的朋友或同事，一起交流。</p>`,108)])])}const d=s(t,[["render",l]]);export{u as __pageData,d as default};
