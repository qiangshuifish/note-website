import{_ as a,H as s,f as p,i as e}from"./chunks/framework.BH2BK_3i.js";const g=JSON.parse('{"title":"26 | 简单设计：难道一开始就要把设计做复杂吗？","description":"","frontmatter":{},"headers":[{"level":2,"title":"KISS","slug":"kiss","link":"#kiss","children":[]},{"level":2,"title":"YAGNI","slug":"yagni","link":"#yagni","children":[]},{"level":2,"title":"DRY","slug":"dry","link":"#dry","children":[]},{"level":2,"title":"简单设计","slug":"简单设计","link":"#简单设计","children":[]},{"level":2,"title":"总结时刻","slug":"总结时刻","link":"#总结时刻","children":[]},{"level":2,"title":"思考题","slug":"思考题","link":"#思考题","children":[]}],"relativePath":"软件设计之美/26-简单设计：难道一开始就要把设计做复杂吗？.md","filePath":"软件设计之美/26-简单设计：难道一开始就要把设计做复杂吗？.md","lastUpdated":1779822537000}'),t={name:"软件设计之美/26-简单设计：难道一开始就要把设计做复杂吗？.md"};function l(i,n,o,u,c,r){return s(),p("div",null,[...n[0]||(n[0]=[e(`<h1 id="_26-简单设计-难道一开始就要把设计做复杂吗" tabindex="-1">26 | 简单设计：难道一开始就要把设计做复杂吗？ <a class="header-anchor" href="#_26-简单设计-难道一开始就要把设计做复杂吗" aria-label="Permalink to &quot;26 | 简单设计：难道一开始就要把设计做复杂吗？&quot;">​</a></h1><p>你好！我是郑晔。</p><p>从专栏开始到现在，关于软件设计，我们已经聊了很多。在学习设计原则和模式这个部分时，我们看着每次的代码调整，虽然结果还不错，但不知道你脑子之中有没有闪过这样的疑问：</p><p>如果我的每段代码都这么写，会不会把设计做复杂了呢？</p><p>确实，几乎每个人在初学设计的时候，都会有用力过猛的倾向。如何把握设计的度，是每个做设计的人需要耐心锤炼的。所以，行业里有人总结了一些实践原则，给了我们一些启发性的规则，帮助我们把握设计的度。</p><p>我把这些原则放到这个部分的最后来讲，是因为它们并不是指导你具体如何编码的原则，它们更像是一种思考方法、一种行为准则。</p><p>好，我们就来看看这样的原则有哪些。</p><h2 id="kiss" tabindex="-1">KISS <a class="header-anchor" href="#kiss" aria-label="Permalink to &quot;KISS&quot;">​</a></h2><p>KISS原则，是“Keep it simple, stupid”的缩写，也就是保持简单、愚蠢的意思。它告诫我们，对于大多数系统而言，和变得复杂相比， <strong>保持简单能够让系统运行得更好</strong>。</p><p>很多程序员都知道这条原则，然而，很少人知道这条原则其实是出自美国海军。所以，它的适用范围远比我们以为的程序员社区要广泛得多。无论是制定一个目标，还是设计一个产品，抑或是管理一个公司，我们都可以用KISS作为一个统一的原则指导自己的工作。</p><p>这个原则看起来有点抽象，每个人对它都会有自己理解的角度，所以，每个人都会觉得它很有道理，而且，越是资深的人越会觉得它有道理。因为资深的人通常都是在自己的工作领域中，见识过因为复杂而引发的各种问题。比如说，堆了太多的功能，调整起来很费劲这样的情况。我们在专栏前面讲过的各种问题，很多时候都是由于复杂引起的。</p><p>所以，对资深的人来说，保持简单是一个再好不过的指引了。其实，每个人都可以针对自己的工作场景给出自己的阐释，比如：</p><ul><li>如果有现成的程序库，就不要自己写；</li><li>能用文本做协议就别用二进制；</li><li>方法写得越小越好；</li><li>能把一个基本的流程打通，软件就可以发布，无需那么多的功能；</li><li>……</li></ul><p>这种级别的原则听上去很有吸引力，但问题是，你并不能用它指导具体的工作。因为，怎么做叫保持简单，怎么做就叫复杂了呢？这个标准是没办法确定的。所以，有人基于自己的理解给出了一些稍微具体一点的原则。比如，在软件开发领域，你可能听说过的YAGNI和DRY原则。</p><h2 id="yagni" tabindex="-1">YAGNI <a class="header-anchor" href="#yagni" aria-label="Permalink to &quot;YAGNI&quot;">​</a></h2><p>YAGNI 是“You aren’t gonna need it”的缩写，也就是，你用不着它。这个说法来自于极限编程社区（Extreme Programming，简称 XP），我们可以把它理解成： <strong>如非必要，勿增功能</strong>。</p><p>我们在开篇词里就说过，软件设计对抗的是需求规模。一方面，我们会通过自己的努力，让软件在需求规模膨胀之后，依然能有一个平稳的发展；另一方面，我们还应该努力地控制需求的规模。</p><p>YAGNI就告诫我们，其实很多需求是不需要做的。很多产品经理以为很重要的功能实际上是没什么用的。人们常说二八原则，真正重要的功能大约只占20%，80%的功能可能大多数人都用不到。做了更多的功能，并不会得到更多的回报，但是，做了更多的功能，软件本身却会不断地膨胀，变得越发难以维护。</p><p>所以，在现实世界中，我们经常看到一些功能简单的东西不断涌现，去颠覆更复杂的东西。比如，虽然Word已经很强大了，但对于很多人而言，它还只是一个写字的工具，甚至它的重点排版功能都用得非常少。</p><p>于是，这就给了Markdown一个机会。它可以让我们专注写内容，而且简单的排版标记在日常沟通中也完全够用。至少，我已经不记得自己上一次用Word写东西是什么时候了。</p><p>我在 <a href="http://https://time.geekbang.org/column/intro/100022301" target="_blank" rel="noreferrer">《10x 程序员工作法》</a> 里写的大部分内容，实际上就是告诉你，什么样的做法可以规避哪些的不必要功能。通过这里的介绍，我们不难发现，YAGNI是一种上游思维，就是尽可能不去做不该做的事，从源头上堵住。从某种意义上说，它比其他各种设计原则都重要。</p><h2 id="dry" tabindex="-1">DRY <a class="header-anchor" href="#dry" aria-label="Permalink to &quot;DRY&quot;">​</a></h2><p>DRY是“Don’t repeat yourself”的缩写，也就是， <strong>不要重复自己</strong>。这个说法源自Andy Hunt和Dave Thomas的《程序员修炼之道》（The Pragmatic Programmer）。这个原则的阐述是这样的：</p><blockquote><p>在一个系统中，每一处知识都必须有单一、明确、权威地表述。</p><p>Every piece of knowledge must have a single, unambiguous, authoritative representation within a system.</p></blockquote><p>每个人对于DRY原则的理解是千差万别的，最浅层的理解就是“不要复制粘贴代码”。不过，两个作者在二十年后的第二版特意强调，这个理解是远远不够的。 <strong>DRY针对的是你对知识和意图的复制</strong>。它强调的是，在两个不同地方的两样东西表达的形式是不同的，但其要表达的内容却可能是相同的。</p><p>我从《程序员修炼之道》中借鉴了一个例子，看看我们怎么在实际的工作中运用 DRY 原则。下面是一段打印账户信息的代码，这种写法在实际的工作中也非常常见：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public void printBalance(final Account account) {</span></span>
...
<span class="line"><span>    System.out.printf(&quot;Balance: %10.2f\\n&quot;, account.getBalance());</span></span>
<span class="line"><span>  }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>然而，在这段代码中，隐藏着一些重复。比如，对负数的处理显然是复制的，可以通过增加一个方法消除它：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>String formatValue(final double value) {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>还有，数字字段格式也是反复出现的，不过，格式与我们抽取出来的方法是一致的，所以，可以复用一下：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>String formatValue(final double value) {</span></span>
<span class="line"><span>  String result = String.format(&quot;%10.2f&quot;, Math.abs(value));</span></span>
<span class="line"><span>  if (value &amp;lt; 0) {</span></span>
<span class="line"><span>    return result + &quot;-&quot;;</span></span>
<span class="line"><span>  } else {</span></span>
...
<span class="line"><span>  System.out.printf(&quot; ----\\n&quot;);</span></span>
<span class="line"><span>  System.out.printf(&quot;Balance:%s\\n&quot;, formatValue(account.getBalance()));</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>再有，这里面的打印格式其实也是重复的，如果我要在标签和金额之间加一个空格，相关的代码都要改，所以，这也是一个可以消除的重复：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>String formatValue(final double value) {</span></span>
<span class="line"><span>  String result = String.format(&quot;%10.2f&quot;, Math.abs(value));</span></span>
<span class="line"><span>  if (value &amp;lt; 0) {</span></span>
<span class="line"><span>    return result + &quot;-&quot;;</span></span>
<span class="line"><span>  } else {</span></span>
