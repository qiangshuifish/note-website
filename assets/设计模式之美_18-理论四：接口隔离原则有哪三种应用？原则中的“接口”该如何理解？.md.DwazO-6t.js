import{_ as s,H as a,f as p,i as e}from"./chunks/framework.BH2BK_3i.js";const g=JSON.parse('{"title":"18 | 理论四：接口隔离原则有哪三种应用？原则中的“接口”该如何理解？","description":"","frontmatter":{},"headers":[{"level":2,"title":"如何理解“接口隔离原则”？","slug":"如何理解-接口隔离原则","link":"#如何理解-接口隔离原则","children":[]},{"level":2,"title":"把“接口”理解为一组API接口集合","slug":"把-接口-理解为一组api接口集合","link":"#把-接口-理解为一组api接口集合","children":[]},{"level":2,"title":"把“接口”理解为单个API接口或函数","slug":"把-接口-理解为单个api接口或函数","link":"#把-接口-理解为单个api接口或函数","children":[]},{"level":2,"title":"把“接口”理解为OOP中的接口概念","slug":"把-接口-理解为oop中的接口概念","link":"#把-接口-理解为oop中的接口概念","children":[]},{"level":2,"title":"重点回顾","slug":"重点回顾","link":"#重点回顾","children":[]},{"level":2,"title":"课堂讨论","slug":"课堂讨论","link":"#课堂讨论","children":[]}],"relativePath":"设计模式之美/18-理论四：接口隔离原则有哪三种应用？原则中的“接口”该如何理解？.md","filePath":"设计模式之美/18-理论四：接口隔离原则有哪三种应用？原则中的“接口”该如何理解？.md","lastUpdated":1779822055000}'),i={name:"设计模式之美/18-理论四：接口隔离原则有哪三种应用？原则中的“接口”该如何理解？.md"};function l(t,n,c,r,o,d){return a(),p("div",null,[...n[0]||(n[0]=[e(`<h1 id="_18-理论四-接口隔离原则有哪三种应用-原则中的-接口-该如何理解" tabindex="-1">18 | 理论四：接口隔离原则有哪三种应用？原则中的“接口”该如何理解？ <a class="header-anchor" href="#_18-理论四-接口隔离原则有哪三种应用-原则中的-接口-该如何理解" aria-label="Permalink to &quot;18 | 理论四：接口隔离原则有哪三种应用？原则中的“接口”该如何理解？&quot;">​</a></h1><p>上几节课中，我们学习了SOLID原则中的单一职责原则、开闭原则和里式替换原则，今天我们学习第四个原则，接口隔离原则。它对应SOLID中的英文字母“I”。对于这个原则，最关键就是理解其中“接口”的含义。那针对“接口”，不同的理解方式，对应在原则上也有不同的解读方式。除此之外，接口隔离原则跟我们之前讲到的单一职责原则还有点儿类似，所以今天我也会具体讲一下它们之间的区别和联系。</p><p>话不多说，现在就让我们正式开始今天的学习吧！</p><h2 id="如何理解-接口隔离原则" tabindex="-1">如何理解“接口隔离原则”？ <a class="header-anchor" href="#如何理解-接口隔离原则" aria-label="Permalink to &quot;如何理解“接口隔离原则”？&quot;">​</a></h2><p>接口隔离原则的英文翻译是“ Interface Segregation Principle”，缩写为ISP。Robert Martin在SOLID原则中是这样定义它的：“Clients should not be forced to depend upon interfaces that they do not use。”直译成中文的话就是：客户端不应该被强迫依赖它不需要的接口。其中的“客户端”，可以理解为接口的调用者或者使用者。</p><p>实际上，“接口”这个名词可以用在很多场合中。生活中我们可以用它来指插座接口等。在软件开发中，我们既可以把它看作一组抽象的约定，也可以具体指系统与系统之间的API接口，还可以特指面向对象编程语言中的接口等。</p><p>前面我提到，理解接口隔离原则的关键，就是理解其中的“接口”二字。在这条原则中，我们可以把“接口”理解为下面三种东西：</p><ul><li>一组API接口集合</li><li>单个API接口或函数</li><li>OOP中的接口概念</li></ul><p>接下来，我就按照这三种理解方式来详细讲一下，在不同的场景下，这条原则具体是如何解读和应用的。</p><h2 id="把-接口-理解为一组api接口集合" tabindex="-1">把“接口”理解为一组API接口集合 <a class="header-anchor" href="#把-接口-理解为一组api接口集合" aria-label="Permalink to &quot;把“接口”理解为一组API接口集合&quot;">​</a></h2><p>我们还是结合一个例子来讲解。微服务用户系统提供了一组跟用户相关的API给其他系统使用，比如：注册、登录、获取用户信息等。具体代码如下所示：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public interface UserService {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><p>在刚刚的这个例子中，我们把接口隔离原则中的接口，理解为一组接口集合，它可以是某个微服务的接口，也可以是某个类库的接口等等。在设计微服务或者类库接口的时候，如果部分接口只被部分调用者使用，那我们就需要将这部分接口隔离出来，单独给对应的调用者使用，而不是强迫其他调用者也依赖这部分不会被用到的接口。</p><h2 id="把-接口-理解为单个api接口或函数" tabindex="-1">把“接口”理解为单个API接口或函数 <a class="header-anchor" href="#把-接口-理解为单个api接口或函数" aria-label="Permalink to &quot;把“接口”理解为单个API接口或函数&quot;">​</a></h2><p>现在我们再换一种理解方式，把接口理解为单个接口或函数（以下为了方便讲解，我都简称为“函数”）。那接口隔离原则就可以理解为：函数的设计要功能单一，不要将多个不同的功能逻辑在一个函数中实现。接下来，我们还是通过一个例子来解释一下。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>public class Statistics {</span></span>
...
<span class="line"><span> */</span></span>
<span class="line"><span>public final int getAndIncrement() {//...}</span></span></code></pre></div><p>欢迎在留言区写下你的答案，和同学一起交流和分享。如果有收获，也欢迎你把这篇文章分享给你的朋友。</p>`,58)])])}const f=s(i,[["render",l]]);export{g as __pageData,f as default};
