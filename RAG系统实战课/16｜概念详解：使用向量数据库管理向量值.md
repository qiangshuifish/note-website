...
![](images/814486/eae2810b5208fc4e5f14fe82585ce98c.jpg)

接着点击蓝色的大象图标，将会打开pgadmin。之后我们按下图所示，选中左侧的Server，鼠标右键点Register，再点Server。

![](images/814486/1ff094e9c26df20f4344a3d5a4ab0be7.jpg)

这时将会弹出如下界面。如果前面你没有修改PostgreSQL的端口，可以直接按照以下界面填写。如果前面你修改了PostgreSQL的端口，则需要修改Port里面的值。

![](images/814486/ae87f2e7db1c8b37b21f06115c9b7372.jpg)

填写好以后，我们点Save按钮。如果一切正常，此时pgadmin的左侧应该会出现以下界面。

![](images/814486/743c1ddc98c76ac13f9d9yyd8ebfd506.jpg)
...
![](images/814486/6fe4e326a8b23d1yy33352506b82e171.jpg)

然后在弹出的窗口里面的Name下拉列表中选择vector，然后再点击Save按钮。

![](images/814486/e707f35543c3fb78c5b08269f419bcf6.jpg)

如果一切正常，此时pgadmin的左侧应该会出现以下界面。Extensions节点下面应该显示有vector节点。

![](images/814486/5f2ce02969fb227aaa56f2ea85be4335.jpg)
...
![](images/814486/b3e5632d7e33036aa62b527d085b330d.jpg)
...
![](images/814486/28b4f91a505f569f3a822eddf66277c6.jpg)

如果一切正常，以上窗口关闭之后，我们应该在pgadmin左侧的Tables看到刚才新建的表。展开这个表的Columns节点之后，应该可以看到刚才新建的三列内容。

![](images/814486/71d42b3c54f216e8c9df3d1bca400762.jpg)
...
![t15](images/814486/141ec5c2ba1495e77545722feb1e0864.jpg)

然后右边的主要脚本窗格将会出现后面这样的的插入数据脚本。

![](images/814486/87aab21bda724a593a0494764526582c.jpg)

我们把里面的 “?” 部分替换成我们想要插入的实际数据即可。没错，这里跟关系数据库里，插入输入的SQL脚本完全一模一样。

修改好SQL脚本之后，我们可以按F5键或者主窗格最上面的箭头来执行SQL。

![](images/814486/c51f3cdeac0f40f0b6f8f87c44e72408.jpg)
